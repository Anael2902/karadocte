<template>
 ...
 <div class="navbar-brand">
  ...
  <path fill-rule="evenodd" clip-rule="evenodd" d="M0 110L10 40L50 0L100 50L70 80L110 120L50 160L0 110Z" fill="currentColor"></path>
    ...
    <div class="navbar-burger js-burger" data-target="navMenuColorprimary-example">
      <span></span>
      <span></span>
      <span></span>
      <span></span>
    ...
    <div class="navbar-end">
      <div class="navbar-item">
        <div class="field is-grouped">
          <p class="control">
            <a class="bd-tw-button button is-primary is-soft" data-social-network="Twitter" data-social-action="tweet" data-social-target="https://bulma.io" target="_blank" href="https://twitter.com/intent/tweet?text=Bulma: a modern CSS framework based on Flexbox&amp;hashtags=bulmaio&amp;url=https://bulma.io&amp;via=jgthms">
              <span class="icon">
          ...
          <p class="control">
            <a class="button is-primary is-light" href="https://github.com/jgthms/bulma/releases/download/1.0.2/bulma-1.0.2.zip">
              <span class="icon">
